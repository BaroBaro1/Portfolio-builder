            ...
            <div className="overflow-hidden rounded-2xl bg-white dark:bg-slate-900">
              ...
              <div className="flex h-[520px] items-center justify-center">
                ...
                <div className="text-center">
                  ...
                  <div className="mx-auto mb-6 flex h-24 w-24 items-center justify-center rounded-full bg-emerald-100 dark:bg-emerald-950/50">
                  ...
                  <p className="mx-auto max-w-md text-lg leading-8 text-slate-600 dark:text-slate-400">
                    This area will display a real portfolio generated by Portfoido
once the portfolio system is completed.
                  </p>
